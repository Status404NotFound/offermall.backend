...
class m170000_700001_advert_finance_month_balance extends Migration
{
    public function safeUp()
    {
        Yii::$app->db->createCommand('CREATE PROCEDURE advert_finance_month_balance(IN AdvertId INT)
  BEGIN
     SELECT
  ...
  END;')->execute();
    ...
    {
        Yii::$app->db->createCommand('DROP PROCEDURE IF EXISTS advert_finance_month_balance')->execute();
    }
}
