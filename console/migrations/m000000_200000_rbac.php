 ...
 * @since 2.0
 */
class m000000_200000_rbac extends \yii\db\Migration
{
    /**
    ...
    public function addData()
    {
         ...
         * Added rule
         */
        $model = new \common\modules\user\models\BizRule(null);
        $model->name = 'RouteRule';
        $model->className = 'common\modules\user\rule\RouteRule';
        $model->save();
        \common\modules\user\helpers\Helper::invalidate();
    }
    /**
     * @inheritdoc
     */
