...
/**
 * Class DeliverySkuStatisticsService
...
class DeliverySkuStatisticsService
{
    ...
    public function deliverySku($filters = null, $pagination = null, $sort_order = null): array
    {
        ...
        if (isset($filters['offer_id'])) $query->andWhere(['advert_offer_target.offer_id' => $filters['offer_id']]);
    ...
    private function deliverySkuQuery(): ActiveQuery
    {
        return OrderSku::find()
            ...
            ->join('LEFT JOIN', 'geo', 'advert_offer_target.geo_id = geo.geo_id')
