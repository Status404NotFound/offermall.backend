...
class WfdDropshipAeExport implements ExportInterface
{
    /**
     * @param null $filters
     * @return array
    ...
    public function compareData($filters = null): array
    {
        ...
        $dataSheet['export_name'] = 'WFD Dropship AE Export';
    ...
    private function findOrders($filters = null)
    {
        $orders = OrderView::find()->select($this->selectFields())
            ...
            ->where(['order_view.order_status' => OrderStatus::WAITING_DELIVERY]);
...
//            '("na") as note',
            'order_view.information as information'
        ];
        return $fields;
    }
