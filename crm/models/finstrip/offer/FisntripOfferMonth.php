...
/**
 * Class FisntripOfferMonth
 * @package crm\models\finstrip\offer
 */
class FisntripOfferMonth extends Finstrip
{
    public $day_month;
     ...
     * @return array
     */
    public function searchOfferMonth($filters): array
    {
    ...
    /**
     * @param $filters
     * @return array|LandingViews[]|\crm\models\finstrip\DayOfferGeoSubCost[]|\yii\db\ActiveRecord[]
     */
...
AND day_offer_geo_sub_cost.offer_id = ' . $filters['offer_id']['value'] . '  AND day_offer_geo_sub_cost.offer_id IN ('.implode(', ', $this->getAdvertOffers($filters['advert_id']['value'])).')
